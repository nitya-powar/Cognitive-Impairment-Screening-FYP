...
"
  ...
  ui <- fluidPage(
      ...
      div(
          ...
          div(
              wellPanel(
                  style = "background-color: #f8f9fa; border-radius: 10px; height: min(620px, calc(100vh - 260px)); overflow-y: auto;",
                  demographicInputs()
                )
            ),
          div(
              wellPanel(
                  style = "background-color: #f0f7ff; border-radius: 10px; height: min(620px, calc(100vh - 260px)); overflow-y: auto;",
                  labInputs()
                )
            ),
          div(
